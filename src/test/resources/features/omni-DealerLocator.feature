...
Scenario: Retrieve all dealer details for a specific geolocal info 
      ...
      * print 'Checksum nettoyé sans guillemets :', generatedChecksum
      ...
      # On s'assure que cet appel utilise aussi un User-Agent technique honnête
      ...
      # --- LIGNES DE DEBUG ---
      * print '=== HTTP STATUS DEALER ===', responseStatus
      * print '=== REPONSE DU SERVEUR DEALER ===', response
